...
async def db_writer_measurements():
    ...
    while True:
        ...
        try:
            ...
            # Convert ts to offset-aware ISO-8601 string for buffer serialization
            ts_iso = bdrv_client.to_buffer_iso(source_ts)
            buffer.add_measurement(ffc_id, msd_id, float(value), ts_iso)
